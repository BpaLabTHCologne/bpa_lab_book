...
The problem arises because Trino does not accept formatted data fields. Unfortunately, the following procedure does not always work, since the Camunda exporters perform schema validation and regenerate the index from their JSON templates.
