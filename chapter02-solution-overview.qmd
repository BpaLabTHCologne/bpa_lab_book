...
The DDD concept is not implemented to full extend, since the BPA Lab uses a central Business Process Management System instance (running  separated processes communicated via messages) to orchestrate the entire process and a central database to ensure data persistence.
