...
| [Integrating IoT Data into Process Mining in an Industry 4.0 Environment](#sec-thesis-kücük-2026) | B. Kücük | Master's thesis | 2026 | requirements catalogue for IoT-enhanced process mining in Industry 4.0, integration approach |
...
## Integrating IoT Data into Process Mining in an Industry 4.0 Environment {#sec-thesis-kücük-2026}
...
This thesis adds a proof-of-concept integration pipeline for IoT-enhanced process mining to the BPA Lab. It connects the workflow event data recorded by Camunda with the MQTT-based IoT observations produced by the Fischertechnik factory layer, making physical factory evidence accessible to process mining tools. 
