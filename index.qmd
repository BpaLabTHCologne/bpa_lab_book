...
By bringing together software and hardware in one running system, abstract concepts become immediately visible.

As a *teaching* platform, the BPA Lab is used to support teaching in the field of business process automation and analysis. It offers students a tangible end-to-end scenario in which processes can be modelled, implemented in a BPMS, executed against physical hardware, and analysed using the resulting data. Individual building blocks of the lab — for instance the Fischertechnik warehouse robot — are also used in **student projects** as starting points for self-defined process implementations. The didactic rationale and an early evaluation of this approach are documented in the project's first SoTL publication ([Projects chapter](chapter05-projects.qmd#sec-sotl-cos1326)).

## Physical setup

![BPA Lab — Conceptual Architecture](images/Conceptional_Architecture.png){#fig-concept fig-align="center"}

This book documents the **physical and software implementation** of the BPA Lab — a small-scale, modular model factory that brings the project's research and teaching mission to life.
