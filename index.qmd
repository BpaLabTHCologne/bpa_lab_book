...
Business process management theory, notations like BPMN and business process automation technologies are often taught using abstract examples — pizza ordering, expense approvals, generic procurement workflows. These examples are accessible but rarely convey:

- the **business complexity** of real-world processes,
...
The BPA Lab as the demonstration factory aims to bridge this gap. The customer order described in the previous chapter  triggers a workflow in Camunda 8, dispatches commands via MQTT to physical hardware, and eventually leads to a real, manufactured product being moved through a real, physical warehouse. This end-to-end visibility of the process execution makes it easier for students to grasp the concepts and technologies of business process automation and analytics. 

It offers lecturers a environment in which existing processes can be changed or new processes be added, implemented in a BPMS, executed against physical hardware, and analysed using the resulting data. Selected building blocks of the lab — for instance the Fischertechnik warehouse robot — can also be used in **student projects** as modules for self-defined process implementations. The didactic rationale and an early evaluation of this approach are documented in the project's first SoTL publication ([Projects chapter](chapter05-projects.qmd#sec-sotl-cos1326)).

## Components of the BPA Lab

This book documents the components of the BPA Lab, which are a **fictional business scenario** and **software and hardware components** as depicted in the figure. In addition, projects executed in the BPA Lab are documented in the [Projects chapter](chapter05-projects.qmd).
...
- Primary for **students** working on bachelor's or master's projects or any other project inside the BPA Lab.
